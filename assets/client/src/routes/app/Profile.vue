<template>
  <div v-if="loaded">
    ...
    <div v-else class="container">
      <div class="middle-container">
        <user-pictures :onlyPP="true" :pictures="userData.pictures" />

        <!-- Here we show the edit link if we own the profile -->
        <router-link v-if="owner" to="/app/profile/me/edit/">edit</router-link>
        ...
        <user-presence v-if="!owner" :target="$route.params.id" />

        <user-interests :tags="userData.interests" type="is-centered" />
